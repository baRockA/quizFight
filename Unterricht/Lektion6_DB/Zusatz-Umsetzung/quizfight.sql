...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 23. Mrz 2020 um 08:35
...
(1, 'Wie heißt die Antwort auf die Frage nach dem Leben, dem Universum und dem ganzen Rest?', '21', '23', '42', '43', 2),
...
CREATE TABLE `users` (
  `uname` varchar(10) COLLATE utf16_bin NOT NULL,
  `password` varchar(64) COLLATE utf16_bin NOT NULL,
  `email` varchar(32) COLLATE utf16_bin DEFAULT NULL,
...
INSERT INTO `users` (`uname`, `password`, `email`, `isadmin`) VALUES
('admin', 'pass42', NULL, 1);
